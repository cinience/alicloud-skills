---
name: aliyun-modelstudio-qwen-coder
...
```bash
mkdir -p output/aliyun-modelstudio-qwen-coder
python -m py_compile skills/ai/code/aliyun-modelstudio-qwen-coder/scripts/prepare_code_request.py && echo "py_compile_ok" > output/aliyun-modelstudio-qwen-coder/validate.txt
```

Pass criteria: command exits 0 and `output/aliyun-modelstudio-qwen-coder/validate.txt` is generated.

## Output And Evidence

- Save prompts, repository context summaries, and normalized coding request payloads under `output/aliyun-modelstudio-qwen-coder/`.
...
```bash
python skills/ai/code/aliyun-modelstudio-qwen-coder/scripts/prepare_code_request.py \
...
- Default output: `output/aliyun-modelstudio-qwen-coder/requests/`
