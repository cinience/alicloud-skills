...
| compute/ecs | aliyun-ecs-spot-provision | 技能 `aliyun-ecs-spot-provision` 的能力說明，詳見對應 SKILL.md。 | `skills/compute/ecs/aliyun-ecs-spot-provision` |
...
| observability/arms | aliyun-arms-query | 技能 `aliyun-arms-query` 的能力說明，詳見對應 SKILL.md。 | `skills/observability/arms/aliyun-arms-query` |
