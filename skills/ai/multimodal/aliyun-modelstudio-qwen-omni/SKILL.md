---
name: aliyun-modelstudio-qwen-omni
...
```bash
mkdir -p output/aliyun-modelstudio-qwen-omni
python -m py_compile skills/ai/multimodal/aliyun-modelstudio-qwen-omni/scripts/prepare_omni_request.py && echo "py_compile_ok" > output/aliyun-modelstudio-qwen-omni/validate.txt
```

Pass criteria: command exits 0 and `output/aliyun-modelstudio-qwen-omni/validate.txt` is generated.
...
```bash
python skills/ai/multimodal/aliyun-modelstudio-qwen-omni/scripts/prepare_omni_request.py \
  --output output/aliyun-modelstudio-qwen-omni/request.json
```
