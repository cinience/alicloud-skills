---
name: aliyun-modelstudio-animate-anyone
...
```bash
mkdir -p output/aliyun-modelstudio-animate-anyone
python -m py_compile skills/ai/video/aliyun-modelstudio-animate-anyone/scripts/prepare_animate_anyone_request.py && echo "py_compile_ok" > output/aliyun-modelstudio-animate-anyone/validate.txt
```

Pass criteria: command exits 0 and `output/aliyun-modelstudio-animate-anyone/validate.txt` is generated.

## Output And Evidence

- Save normalized request payloads, detection outputs, template IDs, and task polling snapshots under `output/aliyun-modelstudio-animate-anyone/`.
...
```bash
python skills/ai/video/aliyun-modelstudio-animate-anyone/scripts/prepare_animate_anyone_request.py \
...
- Default output: `output/aliyun-modelstudio-animate-anyone/request.json`
