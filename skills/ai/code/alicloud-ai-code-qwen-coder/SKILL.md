---
name: alicloud-ai-code-qwen-coder
...
```bash
mkdir -p output/alicloud-ai-code-qwen-coder
python -m py_compile skills/ai/code/alicloud-ai-code-qwen-coder/scripts/prepare_code_request.py && echo "py_compile_ok" > output/alicloud-ai-code-qwen-coder/validate.txt
```

Pass criteria: command exits 0 and `output/alicloud-ai-code-qwen-coder/validate.txt` is generated.

## Output And Evidence

- Save prompts, repository context summaries, and normalized coding request payloads under `output/alicloud-ai-code-qwen-coder/`.
...
```bash
python skills/ai/code/alicloud-ai-code-qwen-coder/scripts/prepare_code_request.py \
...
- Default output: `output/alicloud-ai-code-qwen-coder/requests/`
