---
name: aliyun-modelstudio-wan-r2v
...
```bash
mkdir -p output/aliyun-modelstudio-wan-r2v
python -m py_compile skills/ai/video/aliyun-modelstudio-wan-r2v/scripts/prepare_r2v_request.py && echo "py_compile_ok" > output/aliyun-modelstudio-wan-r2v/validate.txt
```

Pass criteria: command exits 0 and `output/aliyun-modelstudio-wan-r2v/validate.txt` is generated.

## Output And Evidence

- Save reference input metadata, request payloads, and task outputs in `output/aliyun-modelstudio-wan-r2v/`.
...
```bash
.venv/bin/python skills/ai/video/aliyun-modelstudio-wan-r2v/scripts/prepare_r2v_request.py \
...
- Default output: `output/aliyun-modelstudio-wan-r2v/videos/`
