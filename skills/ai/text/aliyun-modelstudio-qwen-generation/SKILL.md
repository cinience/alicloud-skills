---
name: aliyun-modelstudio-qwen-generation
...
```bash
mkdir -p output/aliyun-modelstudio-qwen-generation
python -m py_compile skills/ai/text/aliyun-modelstudio-qwen-generation/scripts/prepare_generation_request.py && echo "py_compile_ok" > output/aliyun-modelstudio-qwen-generation/validate.txt
```

Pass criteria: command exits 0 and `output/aliyun-modelstudio-qwen-generation/validate.txt` is generated.

## Output And Evidence

- Save prompt templates, normalized request payloads, and response summaries under `output/aliyun-modelstudio-qwen-generation/`.
...
```bash
python skills/ai/text/aliyun-modelstudio-qwen-generation/scripts/prepare_generation_request.py \
...
- Default output: `output/aliyun-modelstudio-qwen-generation/requests/`
