---
name: aliyun-modelstudio-aishi-generation
...
```bash
mkdir -p output/aliyun-modelstudio-aishi-generation
python -m py_compile skills/ai/video/aliyun-modelstudio-aishi-generation/scripts/prepare_aishi_request.py && echo "py_compile_ok" > output/aliyun-modelstudio-aishi-generation/validate.txt
```

Pass criteria: command exits 0 and `output/aliyun-modelstudio-aishi-generation/validate.txt` is generated.

## Output And Evidence

- Save normalized request payloads, chosen model variant, and task polling snapshots under `output/aliyun-modelstudio-aishi-generation/`.
...
```bash
python skills/ai/video/aliyun-modelstudio-aishi-generation/scripts/prepare_aishi_request.py \
...
- Default output: `output/aliyun-modelstudio-aishi-generation/request.json`
