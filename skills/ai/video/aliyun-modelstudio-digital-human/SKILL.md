---
name: aliyun-modelstudio-digital-human
...
```bash
mkdir -p output/aliyun-modelstudio-digital-human
python -m py_compile skills/ai/video/aliyun-modelstudio-digital-human/scripts/prepare_digital_human_request.py && echo "py_compile_ok" > output/aliyun-modelstudio-digital-human/validate.txt
```

Pass criteria: command exits 0 and `output/aliyun-modelstudio-digital-human/validate.txt` is generated.

## Output And Evidence

- Save normalized request payloads, chosen resolution, and task polling snapshots under `output/aliyun-modelstudio-digital-human/`.
...
```bash
python skills/ai/video/aliyun-modelstudio-digital-human/scripts/prepare_digital_human_request.py \
...
- Default output: `output/aliyun-modelstudio-digital-human/request.json`
