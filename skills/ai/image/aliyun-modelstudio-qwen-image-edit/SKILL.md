---
name: aliyun-modelstudio-qwen-image-edit
...
```bash
mkdir -p output/aliyun-modelstudio-qwen-image-edit
python -m py_compile skills/ai/image/aliyun-modelstudio-qwen-image-edit/scripts/prepare_edit_request.py && echo "py_compile_ok" > output/aliyun-modelstudio-qwen-image-edit/validate.txt
```

Pass criteria: command exits 0 and `output/aliyun-modelstudio-qwen-image-edit/validate.txt` is generated.

## Output And Evidence

- Save edit request payloads, result URLs, and model parameters under `output/aliyun-modelstudio-qwen-image-edit/`.
...
```bash
.venv/bin/python skills/ai/image/aliyun-modelstudio-qwen-image-edit/scripts/prepare_edit_request.py \
...
- Default output: `output/aliyun-modelstudio-qwen-image-edit/images/`
