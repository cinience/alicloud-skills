...
- Look for project-level `EXTEND.md` at `.alicloud-skills/alicloud-solution-content-article-illustrator/EXTEND.md`.
- Look for user-level `EXTEND.md` at `$HOME/.alicloud-skills/alicloud-solution-content-article-illustrator/EXTEND.md`.
