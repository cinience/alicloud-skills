---
name: aliyun-modelstudio-qwen-vl
...
```bash
mkdir -p output/aliyun-modelstudio-qwen-vl
python -m py_compile skills/ai/multimodal/aliyun-modelstudio-qwen-vl/scripts/analyze_image.py && echo "py_compile_ok" > output/aliyun-modelstudio-qwen-vl/validate.txt
```

Pass criteria: command exits 0 and `output/aliyun-modelstudio-qwen-vl/validate.txt` is generated.

## Output And Evidence

- Save raw model responses and normalized extraction results to `output/aliyun-modelstudio-qwen-vl/`.
...
For OCR-specialized extraction, prefer `skills/ai/multimodal/aliyun-modelstudio-qwen-ocr/` instead of using the general VL skill.
...
```bash
python skills/ai/multimodal/aliyun-modelstudio-qwen-vl/scripts/analyze_image.py \
...
python skills/ai/multimodal/aliyun-modelstudio-qwen-vl/scripts/analyze_image.py \
  ...
  --schema skills/ai/multimodal/aliyun-modelstudio-qwen-vl/references/examples/invoice.schema.json \
  --print-response
```
...
- Default output dir convention: `output/aliyun-modelstudio-qwen-vl/`.

## Smoke test

```bash
python tests/ai/multimodal/aliyun-modelstudio-qwen-vl-test/scripts/smoke_test_qwen_vl.py \
