---
name: alicloud-ai-research-qwen-deep-research
...
```bash
mkdir -p output/alicloud-ai-research-qwen-deep-research
python -m py_compile skills/ai/research/alicloud-ai-research-qwen-deep-research/scripts/prepare_deep_research_request.py && echo "py_compile_ok" > output/alicloud-ai-research-qwen-deep-research/validate.txt
```

Pass criteria: command exits 0 and `output/alicloud-ai-research-qwen-deep-research/validate.txt` is generated.

## Output And Evidence

- Save research goals, confirmation answers, normalized request payloads, and final report snapshots under `output/alicloud-ai-research-qwen-deep-research/`.
...
```bash
python skills/ai/research/alicloud-ai-research-qwen-deep-research/scripts/prepare_deep_research_request.py \
...
- Default output: `output/alicloud-ai-research-qwen-deep-research/requests/`
