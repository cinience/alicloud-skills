---
name: alicloud-ai-multimodal-qwen-ocr
...
- Save request payloads, selected OCR task name, and normalized output expectations under `output/alicloud-ai-multimodal-qwen-ocr/`.
...
- Default output: `output/alicloud-ai-multimodal-qwen-ocr/request.json`
