...
- Save normalized request payloads, detection boxes, and task polling snapshots under `output/alicloud-ai-video-emo/`.
...
- Default output: `output/alicloud-ai-video-emo/request.json`
